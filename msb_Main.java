...
public class msb_Main extends JFrame {
	...
	public msb_Main() {
		...
		btn_Match_Barcodes.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try
				{
					msb_Match_Barcodes obj_MB = new msb_Match_Barcodes();
					obj_MB.main(args);
		...
		btn_Scratch_Barcodes.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try
				{
					msb_Scratch_Barcodes obj_SB = new msb_Scratch_Barcodes();
					obj_SB.main(args);
