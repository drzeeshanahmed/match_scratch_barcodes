...
public class msb_Match_Barcodes extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					msb_Match_Barcodes frame = new msb_Match_Barcodes();
	...
	public void Find_Positive_Positive_Reads()
	{
		...
		{
			int b_count =  JTable_Multiple_Barcodes.getRowCount();
			JOptionPane.showMessageDialog(null, "Matched # " +  b_count , "Positive +", JOptionPane.PLAIN_MESSAGE);
	...
	public msb_Match_Barcodes() {
		...
		panel_Reverse_Adapters_Barcodes.setBackground(new Color(255, 240, 245));
		
		JPanel panel_Tabs = new JPanel();
		panel_Tabs.setBackground(Color.WHITE);
		
		JPanel panel_Forward_Adapters_Barcodes = new JPanel();
		panel_Forward_Adapters_Barcodes.setBackground(new Color(224, 255, 255));
		...
		JLabel lblNewLabel_26 = new JLabel("Developed by Asst. Prof. Dr. Zeeshan AHMED");
			...
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addComponent(panel_Tabs, GroupLayout.PREFERRED_SIZE, 1391, GroupLayout.PREFERRED_SIZE)
						.addGroup(gl_contentPane.createSequentialGroup()
							.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
								...
								.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
									...
									.addGroup(Alignment.TRAILING, gl_contentPane.createSequentialGroup()
										.addComponent(panel_Forward_Adapters_Barcodes, GroupLayout.PREFERRED_SIZE, 517, GroupLayout.PREFERRED_SIZE)
										.addPreferredGap(ComponentPlacement.RELATED)
										.addComponent(panel_Reverse_Adapters_Barcodes, GroupLayout.PREFERRED_SIZE, 508, GroupLayout.PREFERRED_SIZE))))
							.addPreferredGap(ComponentPlacement.UNRELATED)
			...
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING, false)
						...
						.addComponent(panel_Forward_Adapters_Barcodes, Alignment.TRAILING, 0, 0, Short.MAX_VALUE)
						.addComponent(panel_Reverse_Adapters_Barcodes, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
					.addPreferredGap(ComponentPlacement.RELATED)
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
						...
						.addComponent(lbl_Count_Reads))
					.addPreferredGap(ComponentPlacement.RELATED)
					.addComponent(panel_Tabs, GroupLayout.PREFERRED_SIZE, 555, GroupLayout.PREFERRED_SIZE)
					.addPreferredGap(ComponentPlacement.RELATED)
					.addComponent(lblNewLabel_26)
		...
		chk_Match_Reverse_Sequence.setBackground(new Color(255, 255, 255));
		panel.add(chk_Match_Reverse_Sequence);
		chk_Match_Reverse_Sequence.setSelected(true);
		
		chk_Reverse_Bases_Order = new JCheckBox("Reverse Bases Order");
		chk_Reverse_Bases_Order.setBackground(new Color(255, 255, 255));
		panel.add(chk_Reverse_Bases_Order);
		chk_Reverse_Bases_Order.setToolTipText("Reverse Bases Order");
		
		chk_Pick_Number_of_Bases = new JCheckBox("Start & End Bases #");
		chk_Pick_Number_of_Bases.setBackground(new Color(255, 255, 255));
		panel.add(chk_Pick_Number_of_Bases);
		...
		panel.add(txt_Start_Bases_Length);
		txt_Start_Bases_Length.setText("40");
		txt_Start_Bases_Length.setColumns(5);
		
		JLabel lblNewLabel_22 = new JLabel("Bases End");
		panel.add(lblNewLabel_22);
		
		txt_End_Bases_Length = new JTextField();
		panel.add(txt_End_Bases_Length);
		txt_End_Bases_Length.setText("40");
		txt_End_Bases_Length.setColumns(5);
		
		JButton btn_GetCount = new JButton("Count Input Adatpers & Barcodes");
		btn_GetCount.setBackground(new Color(255, 255, 255));
		panel.add(btn_GetCount);
		
		JButton btn_FalsePositiveReads = new JButton("False Positive");
		btn_FalsePositiveReads.setBackground(new Color(255, 255, 255));
		panel.add(btn_FalsePositiveReads);
		
		JButton btnNewButton = new JButton("Postive +");
		btnNewButton.setBackground(new Color(255, 255, 255));
		panel.add(btnNewButton);
		
		JButton btn_ExampleBarcodes = new JButton("Example Barcodes");
		btn_ExampleBarcodes.setBackground(new Color(255, 255, 255));
		btn_ExampleBarcodes.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try
				{
					rtxt_Forward_Start_Adapters.setText("AATGATACGGCGACCACCGAGATCTACAC");
					rtxt_Forward_End_Adapters.setText("ATCTCGTATGCCGTCTTCTGCTTG");
					rtxt_Reverse_Start_Adapters.setText("TTACTATGCCGCTGGTGGCTCTAGATGTG");
					rtxt_Reverse_End_Adapters.setText("TAGAGCATACGGCAGAAGACGAAC");
		...
		panel.add(btn_ExampleBarcodes);
		
		JButton btn_Start_Analysis = new JButton("Start Analysis");
		btn_Start_Analysis.setBackground(new Color(255, 255, 255));
		panel.add(btn_Start_Analysis);
		...
		lbl_Forward_Start_Adapters.setFont(new Font("Tahoma", Font.PLAIN, 12));
		
		JLabel lblNewLabel_1 = new JLabel("Forward - End - Adapters");
		lblNewLabel_1.setFont(new Font("Tahoma", Font.PLAIN, 12));
		lbl_Forward_End_Adapters = new JLabel("...");
		lbl_Forward_End_Adapters.setFont(new Font("Tahoma", Font.PLAIN, 12));
		...
		lbl_Forward_Start_Barcodes.setFont(new Font("Tahoma", Font.PLAIN, 12));
		...
		lbl_Forward_End_Barcodes.setFont(new Font("Tahoma", Font.PLAIN, 12));
		...
		gl_panel_Forward_Adapters_Barcodes.setHorizontalGroup(
			gl_panel_Forward_Adapters_Barcodes.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_panel_Forward_Adapters_Barcodes.createSequentialGroup()
					...
					.addGroup(gl_panel_Forward_Adapters_Barcodes.createParallelGroup(Alignment.LEADING)
						.addComponent(scrollPane_Forward_End_Adapters, GroupLayout.DEFAULT_SIZE, 295, Short.MAX_VALUE)
						.addComponent(scrollPane_Forward_Start_Adapters, GroupLayout.DEFAULT_SIZE, 295, Short.MAX_VALUE)
						.addComponent(scrollPane_Forward_End_Barcodes, GroupLayout.DEFAULT_SIZE, 295, Short.MAX_VALUE)
						.addComponent(scrollPane_Forward_Start_Barcodes, GroupLayout.DEFAULT_SIZE, 295, Short.MAX_VALUE))
					.addContainerGap())
				.addGroup(gl_panel_Forward_Adapters_Barcodes.createSequentialGroup()
		...
		gl_panel_Forward_Adapters_Barcodes.setVerticalGroup(
			gl_panel_Forward_Adapters_Barcodes.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_Forward_Adapters_Barcodes.createSequentialGroup()
					...
					.addGroup(gl_panel_Forward_Adapters_Barcodes.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_panel_Forward_Adapters_Barcodes.createSequentialGroup()
							.addGroup(gl_panel_Forward_Adapters_Barcodes.createParallelGroup(Alignment.BASELINE)
								.addComponent(scrollPane_Forward_Start_Adapters, GroupLayout.PREFERRED_SIZE, 45, GroupLayout.PREFERRED_SIZE)
								.addComponent(lblNewLabel))
							.addPreferredGap(ComponentPlacement.RELATED)
							.addGroup(gl_panel_Forward_Adapters_Barcodes.createParallelGroup(Alignment.BASELINE)
								.addComponent(scrollPane_Forward_End_Adapters, GroupLayout.PREFERRED_SIZE, 48, GroupLayout.PREFERRED_SIZE)
								.addGroup(gl_panel_Forward_Adapters_Barcodes.createSequentialGroup()
									.addComponent(lblNewLabel_1)
									.addPreferredGap(ComponentPlacement.RELATED)
									.addComponent(lbl_Forward_End_Adapters)))))
					.addPreferredGap(ComponentPlacement.RELATED)
					.addGroup(gl_panel_Forward_Adapters_Barcodes.createParallelGroup(Alignment.BASELINE)
						.addComponent(scrollPane_Forward_Start_Barcodes, GroupLayout.PREFERRED_SIZE, 57, GroupLayout.PREFERRED_SIZE)
						.addGroup(gl_panel_Forward_Adapters_Barcodes.createSequentialGroup()
							.addComponent(lblNewLabel_4)
							.addGap(3)
							.addComponent(lbl_Forward_Start_Barcodes)))
					.addGap(10)
					.addGroup(gl_panel_Forward_Adapters_Barcodes.createParallelGroup(Alignment.BASELINE)
						.addComponent(scrollPane_Forward_End_Barcodes, GroupLayout.PREFERRED_SIZE, 48, GroupLayout.PREFERRED_SIZE)
						.addGroup(gl_panel_Forward_Adapters_Barcodes.createSequentialGroup()
							.addComponent(lblNewLabel_6)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(lbl_Forward_End_Barcodes)))
		...
		tabbedPane_Barcodes.setBackground(new Color(255, 255, 255));
		...
		gl_panel_Tabs.setHorizontalGroup(
			gl_panel_Tabs.createParallelGroup(Alignment.TRAILING)
				.addGroup(Alignment.LEADING, gl_panel_Tabs.createSequentialGroup()
					.addContainerGap()
					.addComponent(tabbedPane_Barcodes, GroupLayout.PREFERRED_SIZE, 1373, GroupLayout.PREFERRED_SIZE)
					.addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
		);
		gl_panel_Tabs.setVerticalGroup(
			gl_panel_Tabs.createParallelGroup(Alignment.TRAILING)
				.addGroup(Alignment.LEADING, gl_panel_Tabs.createSequentialGroup()
					.addContainerGap()
					.addComponent(tabbedPane_Barcodes, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
					.addContainerGap(57, Short.MAX_VALUE))
		);
		
		JPanel panel_UnMatchedReads = new JPanel();
		panel_UnMatchedReads.setBackground(new Color(255, 255, 255));
		...
		btn_Export_UnMatched_Reads.setBackground(new Color(255, 255, 255));
		btn_Export_UnMatched_Reads.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try
				{
					...
					{
						msb_Write_to_Excel obj_CSV = new msb_Write_to_Excel();
		...
		jpanle_Individual_Adapters.setBackground(new Color(255, 255, 255));
		...
		jpanle_Multiple_Adapters.setBackground(new Color(255, 255, 255));
		...
		btn_Export_MultipleAdapters.setBackground(new Color(255, 255, 255));
		...
		jpanle_Individual_Barcodes.setBackground(new Color(255, 255, 255));
		...
		btn_Export_Individual_Barcodes.setBackground(new Color(255, 255, 255));
		...
		jpanle_Multiple_Barcodes.setBackground(new Color(255, 255, 255));
		...
		btn_Export_MultipleBarcodes.setBackground(new Color(255, 255, 255));
		...
		btn_Sort_Matches.setBackground(new Color(255, 255, 255));
		...
		chk_DistinctCombination_Froward.setBackground(new Color(255, 255, 255));
		...
		chk_DistinctCombination_Reverse.setBackground(new Color(255, 255, 255));
		...
		btn_Delete_MultipleBarcodes.setBackground(new Color(255, 255, 255));
		...
		chk_OnlyCombinationsWithoutReads.setBackground(new Color(255, 255, 255));
		...
		panel_Distinct_Multiple_Barcodes_Matches.setBackground(new Color(255, 255, 255));
		...
		btn_Export_Sorted_Multiple_Barcode_Matches.setBackground(new Color(255, 255, 255));
		...
		JButton btn_Common_FR_Barcode_Combinations = new JButton("Common FR Comb.");
		btn_Common_FR_Barcode_Combinations.setBackground(new Color(255, 255, 255));
		...
		JButton btn_Distinct_FR_Barcode_Combinations = new JButton("Distinct FR Comb.");
		btn_Distinct_FR_Barcode_Combinations.setBackground(new Color(255, 255, 255));
		...
		panel_Distinct_FR_Combinations.setBackground(new Color(255, 255, 255));
		...
		btn_Export_Distinct_FR_Combinations.setBackground(new Color(255, 255, 255));
		...
		btn_CreateFasta_Distinct_FR_Combinations.setBackground(new Color(255, 255, 255));
		...
		btn_CreateFastQ_Distinct_FR_Combinations.setBackground(new Color(255, 255, 255));
		...
		lbl_Reverse_End_Adapter.setFont(new Font("Tahoma", Font.PLAIN, 12));
		lbl_Reverse_Start_Adapter = new JLabel("...");
		lbl_Reverse_Start_Adapter.setFont(new Font("Tahoma", Font.PLAIN, 12));
		
		JLabel lblNewLabel_5 = new JLabel("Reverse - End - Barcodes");
		lblNewLabel_5.setFont(new Font("Tahoma", Font.PLAIN, 12));
		
		lbl_Reverse_End_Barcode = new JLabel("...");
		lbl_Reverse_End_Barcode.setFont(new Font("Tahoma", Font.PLAIN, 12));
		...
		lbl_Reverse_Start_Barcode.setFont(new Font("Tahoma", Font.PLAIN, 12));
		...
		gl_panel_Reverse_Adapters_Barcodes.setHorizontalGroup(
			gl_panel_Reverse_Adapters_Barcodes.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_Reverse_Adapters_Barcodes.createSequentialGroup()
					...
					.addGap(18)
					.addGroup(gl_panel_Reverse_Adapters_Barcodes.createParallelGroup(Alignment.TRAILING)
						.addComponent(scrollPane_Reverse_End_Barcodes, GroupLayout.DEFAULT_SIZE, 176, Short.MAX_VALUE)
						.addComponent(scrollPane_Reverse_Start_Adapters, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 176, Short.MAX_VALUE)
						.addComponent(scrollPane_Reverse_Start_Barcodes, GroupLayout.DEFAULT_SIZE, 176, Short.MAX_VALUE)
						.addComponent(scrollPane_Reverse_End_Adapters, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 176, Short.MAX_VALUE))
					.addContainerGap())
		);
			...
			gl_panel_Reverse_Adapters_Barcodes.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_Reverse_Adapters_Barcodes.createSequentialGroup()
					...
					.addGroup(gl_panel_Reverse_Adapters_Barcodes.createParallelGroup(Alignment.BASELINE)
						...
						.addComponent(scrollPane_Reverse_Start_Adapters, GroupLayout.PREFERRED_SIZE, 46, GroupLayout.PREFERRED_SIZE))
					.addPreferredGap(ComponentPlacement.RELATED)
					.addGroup(gl_panel_Reverse_Adapters_Barcodes.createParallelGroup(Alignment.LEADING)
						...
						.addComponent(scrollPane_Reverse_End_Adapters, GroupLayout.PREFERRED_SIZE, 49, GroupLayout.PREFERRED_SIZE))
					.addPreferredGap(ComponentPlacement.RELATED)
					.addGroup(gl_panel_Reverse_Adapters_Barcodes.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel_Reverse_Adapters_Barcodes.createSequentialGroup()
							.addGap(3)
						...
						.addGroup(gl_panel_Reverse_Adapters_Barcodes.createSequentialGroup()
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(scrollPane_Reverse_Start_Barcodes, GroupLayout.PREFERRED_SIZE, 45, GroupLayout.PREFERRED_SIZE)))
					.addPreferredGap(ComponentPlacement.RELATED)
					.addGroup(gl_panel_Reverse_Adapters_Barcodes.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel_Reverse_Adapters_Barcodes.createSequentialGroup()
							.addGap(20)
							.addComponent(lbl_Reverse_Start_Barcode))
						.addGroup(gl_panel_Reverse_Adapters_Barcodes.createParallelGroup(Alignment.BASELINE)
							.addComponent(scrollPane_Reverse_End_Barcodes, GroupLayout.PREFERRED_SIZE, 44, GroupLayout.PREFERRED_SIZE)
							.addComponent(lblNewLabel_7)))
